package dev.mamekun.springboot.jpa.data.dao.impl;

import dev.mamekun.springboot.jpa.data.dao.ProductDAO;
import dev.mamekun.springboot.jpa.data.entity.Product;
import dev.mamekun.springboot.jpa.data.repository.ProductRepository;
